<%@ Page Title="Daftar Bank" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Daftarbank.aspx.vb" Inherits="IME.Daftarbank" %>
                        ...
                        <div class="row vert-pad-10px">
                            <div class="col-md-3">
                                <div class="form-group btn-group">
                                    <a href="./daftarbank-data.aspx" class="btn btn-default"><i class="fa fa-plus "></i></a>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr data-ng-repeat="item in items">
                                        <td>
                                            <input type="checkbox" />
                                            <a href="daftarbank-data.aspx?id={{ item.daftarbankinput_id }}"><i class="fa fa-edit" ></i></a>
                                        </td>
                                        <td>{{ item.daftarbankinput_id }}</td>
                                        <td>{{ item.Companycode }}</td>
                                        <td>{{ item.KodeBankKey }}</td>
    ...
    <script type="text/javascript">
        ...
        var pagecontrol = function ($scope, $filter, $window, $http) {
            ...
            $scope.initializedata = function () {
                var post = $http({
                    method: "POST",
                    url: "./Daftarbank.aspx/InitializeData",
                    dataType: 'json',
                    data: { },
            ...
            $scope.searchid = function () {
                ...
                var post = $http({
                    method: "POST",
                    url: "./Daftarbank.aspx/SearchData",
                    dataType: 'json',
