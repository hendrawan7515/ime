<%@ Page Title="Master Type Bank Input" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Mastertypebank-data.aspx.vb" Inherits="IME.Mastertypebank_data" %>
            ...
            <div class="col-md-12">
                <div class="page-header">
                    <h1><i class="fa fa-file-text"></i>
                        <small>PARAMETER JENIS REKENING </small>
                    </h1>
                </div>
            </div>
        </div>
                ...
                <div class="panel-body">
                            ...
                            <div class="form-horizontal">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="JenisRekening" class="col-md-4 align-left">Jenis Rekening</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id="JenisRekening" placeholder="Jenis Rekening" data-ng-model="inputData.jenis_rekening" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="container-fluid">
                        <div class="row vert-pad-10px">
                            <div class="col-xs-3 ">
                                <a href="./Mastertypebank.aspx" class="btn btn-primary w100">Kembali <i class="fa fa-reply"></i></a>
                            </div>
    ...
    <script type="text/javascript">
        ...
        var pagecontrol = function ($scope, $location, $http ) {
            ...
            $scope.initializedata = function () {
                ...
                var post = $http({
                    method: "POST",
                    url: "./Mastertypebank-data.aspx/InitializeData",
                    dataType: 'json',
            ...
            $scope.populatecombo = function () {
                var post = $http({
                    method: "POST",
                    url: "./Mastertypebank-data.aspx/GetComboData",
                    dataType: 'json',
                    data: {  },
                    headers: { "Content-Type": "application/json" }
                }).then(function successCallBack(response) {
            ...
            $scope.resetData = function () {
                ...
                $scope.inputData.jenis_rekening = '';
            ...
            $scope.saveData = function () {
                ...
                var post = $http({
                    method: "POST",
                    url: "./Mastertypebank-data.aspx/Save",
                    dataType: 'json',
                    data: { input: $scope.inputData },
                    headers: { "Content-Type": "application/json" }
                }).then(function successCallBack(response) {
