<%@ Page Title="Master Type Bank" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Mastertypebank.aspx.vb" Inherits="IME.Mastertypebank" %>
                        ...
                        <div class="row vert-pad-10px">
                            <div class="col-md-3">
                                <div class="form-group btn-group">
                                    <a href="./Mastertypebank-data.aspx" class="btn btn-default"><i class="fa fa-plus "></i></a>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr data-ng-repeat="item in items">
                                        <td>
                                            <input type="checkbox" />
                                            <a href="Mastertypebank-data.aspx?id={{ item.mastertypebak_id }}"><i class="fa fa-edit" ></i></a>
                                        </td>
                                        <td>{{ item.mastertypebak_id }}</td>
    ...
    <script type="text/javascript">
        ...
        var pagecontrol = function ($scope, $filter, $window, $http) {
            ...
            $scope.initializedata = function () {
                var post = $http({
                    method: "POST",
                    url: "./Mastertypebank.aspx/InitializeData",
                    dataType: 'json',
                    data: { },
            ...
            $scope.searchid = function () {
                ...
                var post = $http({
                    method: "POST",
                    url: "./Mastertypebank.aspx/SearchData",
                    dataType: 'json',
