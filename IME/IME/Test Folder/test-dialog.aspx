<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="test-dialog.aspx.vb" Inherits="IME.test_dialog" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Test Dialog Angular JS</title>
    ...
    <form id="form1" runat="server">
        <div ng-controller="AppCtrl" class="md-padding dialogdemoBasicUsage" id="popupContainer" ng-cloak="" ng-app="MyApp">
            ...
            <div ng-if="status" id="status">
                <b layout="row" layout-align="center center" class="md-padding">{{status}}
                </b>
            </div>
    ...
    <md-dialog-actions layout="row">
      ...
      <md-button ng-click="answer('useful')" style="margin-right:20px;" >
        ...
        <script type="text/javascript">
            angular.module('MyApp', ['ngMaterial', 'ngMessages', 'material.svgAssetsCache']).controller('AppCtrl', function ($scope, $mdDialog) {
                $scope.status = '  ';
