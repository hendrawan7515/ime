<%@ Page Title="Master Type Activity Group Input" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Masteractivitygroup-data.aspx.vb" Inherits="IME.Masteractivitygroup_data" %>
            ...
            <div class="col-md-12">
                <div class="page-header">
                    <h1><i class="fa fa-file-text"></i>
                        <small>PARAMETER GRUP AKTIFITAS </small>
                    </h1>
                </div>
            </div>
        </div>
                ...
                <div class="panel-body">
                            ...
                            <div class="form-horizontal">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="JenisKomoditi" class="col-md-4 align-left">Jenis Komoditi</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id="JenisKomoditi" placeholder="Jenis Komoditi" data-ng-model="inputData.jenis_komoditi" />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="GrupAktifitas" class="col-md-4 align-left">Grup Aktifitas</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id="GrupAktifitas" placeholder="Grup Aktifitas" data-ng-model="inputData.grup_aktifitas" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <!--<label for="fulldesc" class="col-md-4 align-left;fa-text-height=w100;">&nbsp;</label>-->
                                          <div class="col-md-8a">
                                             <div class="input-group">
                                                 <input class="form-control" style="visibility:hidden" />
                                             </div>
                    ...
                    <div class="container-fluid">
                        <div class="row vert-pad-10px">
                            <div class="col-xs-3 ">
                                <a href="./Masteractivitygroup.aspx" class="btn btn-primary w100">Kembali <i class="fa fa-reply"></i></a>
                            </div>
    ...
    <script type="text/javascript">
        ...
        var pagecontrol = function ($scope, $location, $http ) {
            ...
            $scope.initializedata = function () {
                ...
                var post = $http({
                    method: "POST",
                    url: "./Masteractivitygroup-data.aspx/InitializeData",
                    dataType: 'json',
            ...
            $scope.populatecombo = function () {
                var post = $http({
                    method: "POST",
                    url: "./Masteractivitygroup-data.aspx/GetComboData",
                    dataType: 'json',
                    data: {  },
                    headers: { "Content-Type": "application/json" }
                }).then(function successCallBack(response) {
            ...
            $scope.resetData = function () {
                ...
                $scope.inputData.Companycode = 'tes';
                $scope.inputData.jenis_komoditi = '';
                $scope.inputData.grup_aktifitas = '';
            ...
            $scope.saveData = function () {
                ...
                var post = $http({
                    method: "POST",
                    url: "./Masteractivitygroup-data.aspx/Save",
                    dataType: 'json',
                    data: { input: $scope.inputData },
                    headers: { "Content-Type": "application/json" }
                }).then(function successCallBack(response) {
